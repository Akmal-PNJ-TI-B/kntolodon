...
### Capabilities & Scope
1.  **Local Git Operations:** Initialize repos, stage files, create commits, switch/create branches, and perform merges.
...
* **Commit Message Format:** ALWAYS use a multi-line structure:
    * **Subject Line (First line):** A brief, general summary of what changed (e.g., "Update login page layout").
    * **Body (Second line+):** The technical classification using Conventional Commits and specific details (e.g., "feat: add responsive css for mobile devices", "fix: resolve z-index issue").
